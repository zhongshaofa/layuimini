...
layui.define(["element", "jquery", "layer"], function (exports) {
        ...
        layuimini = new function () {
            ...
            this.initHome = function (data) {
                ...
                if (!localhostHref.match(RegExp(/#/))) {
                    layuimini.initConten('.layuimini-content-page', data.href, false);
                }
            };
             ...
             * @param isHash
             */
            this.initConten = function (container, href, isHash) {
         ...
         * 关闭选项卡
         **/
        $('body').on('click', '[data-one-page-close]', function () {
            var loading = layer.load(0, {shade: false, time: 2 * 1000});
            $parent = $(this).parent();
            tabId = $attr('lay-id');
        ...
        $('body').on('click', '[data-one-page]', function () {
            var loading = layer.load(0, {shade: false, time: 2 * 1000});
            var tabId = $(this).attr('data-one-page'),
                href = $(this).attr('data-one-page'),
                title = $(this).html(),
